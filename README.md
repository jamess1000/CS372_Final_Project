...
## Evaluation
Results: the model that we would put forward for submission is the ViT fine-tuned model. 
For a more detailed analysis on evaluation, see the model_comparison_fin notebook.
